...
from transformers import LlamaConfig, LlamaForCausalLM, LlamaTokenizerFast, FalconConfig, FalconForCausalLM, \
    AutoTokenizer, MistralConfig, MistralForCausalLM
...
def write_llama_model(model_path,
    ...
    assert len(list(base_path.glob("mp_rank_*"))) == 1, "Unshard your model with checkpoint/convert.py first!"
    ...
    with TemporaryDirectory() as tmp_model_path:
        ...
        for layer_i in range(n_layers):
            ...
            state_dict = {
                ...
                f"model.layers.{layer_i}.self_attn.o_proj.weight": loaded["transformer"][
                ...
                f"model.layers.{layer_i}.input_norm.weight": loaded["transformer"][
                    f"layers.{layer_i}.input_norm.weight"],
                f"model.layers.{layer_i}.post_attention_norm.weight": loaded["transformer"][
    ...
    with TemporaryDirectory() as tmp_model_path:
        ...
        for layer_i in range(n_layers):
            ...
            state_dict = {
                ...
                f"model.layers.{layer_i}.post_attention_layernorm.weight": loaded["transformer"][
